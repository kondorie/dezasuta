        ...
        <div class="header_wrap">
            ...
            <nav class="pc_nav">
                <ul id="page_link">
                    ...
                    <li <?php if(is_category('blog-all')){ echo ' class="current"';} ?>><a href="/category/blog-all/">日記</a></li>
                    <li <?php if(is_page('works')){ echo ' class="current"';} ?>><a href="/works/">制作実績</a></li>
                    <li <?php if(is_home()){ echo ' class="current"'; } ?>><a href="<?php echo home_url(); ?>">トップページ</a></li>
                </ul>
            </nav>
